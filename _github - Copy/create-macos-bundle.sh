...
if [ -f "FMSquared.AvaloniaUI/Info.plist" ]; then
    cp "FMSquared.AvaloniaUI/Info.plist" "${BUNDLE_PATH}/Contents/Info.plist"
    ...
    echo "Warning: Info.plist template not found at FMSquared.AvaloniaUI/Info.plist"
fi

# Make the executable and native libraries executable
echo "Setting executable permissions..."
chmod +x "${BUNDLE_PATH}/Contents/MacOS/FMSquared"
...
if [ -f "FMSquared.AvaloniaUI/Assets/icon.icns" ]; then
    cp "FMSquared.AvaloniaUI/Assets/icon.icns" "${BUNDLE_PATH}/Contents/Resources/"
