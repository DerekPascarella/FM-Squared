...
/// On macOS, stored in ~/Library/Application Support/FMSquared/ since
...
public class AppSettings
{
    ...
    private static string GetSettingsDir()
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
        {
            ...
            return Path.Combine(home, "Library", "Application Support", "FMSquared");
        }
    ...
    public void Save()
    {
        ...
        {
            // The settings file can be read-only or inaccessible, so a failed save is ignored.
        }
    }
