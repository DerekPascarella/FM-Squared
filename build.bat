...
echo ================================================
set OUTPUT_DIR=_releases\FMSquared.%VERSION%-win-x64
dotnet publish FMSquared.WPF\FMSquared.WPF.csproj -c Release -o "%OUTPUT_DIR%"
if %ERRORLEVEL% neq 0 goto :error
...
cd "%OUTPUT_DIR%" && tar -a -c -f ..\FMSquared.%VERSION%-win-x64.zip * && cd ..\..
...
echo ================================================
set OUTPUT_DIR=_releases\FMSquared.%VERSION%-win-x86
dotnet publish FMSquared.WPF\FMSquared.WPF.csproj -c Release -r win-x86 --self-contained false -o "%OUTPUT_DIR%"
if %ERRORLEVEL% neq 0 goto :error
xcopy /E /I /Y tools "%OUTPUT_DIR%\tools\"
if exist LICENSE copy /Y LICENSE "%OUTPUT_DIR%\" >nul
if exist README.md copy /Y README.md "%OUTPUT_DIR%\" >nul
cd "%OUTPUT_DIR%" && tar -a -c -f ..\FMSquared.%VERSION%-win-x86.zip * && cd ..\..
...
if exist "FMSquared.Core\bin" rd /s /q "FMSquared.Core\bin"
if exist "FMSquared.Core\obj" rd /s /q "FMSquared.Core\obj"
if exist "FMSquared.AvaloniaUI\bin" rd /s /q "FMSquared.AvaloniaUI\bin"
if exist "FMSquared.AvaloniaUI\obj" rd /s /q "FMSquared.AvaloniaUI\obj"
...
echo ================================================
set OUTPUT_DIR=_releases\FMSquared.%VERSION%-linux-x64
dotnet publish FMSquared.AvaloniaUI\FMSquared.AvaloniaUI.csproj -c Release --self-contained true -r linux-x64 -p:PublishSingleFile=false -o "%OUTPUT_DIR%"
if %ERRORLEVEL% neq 0 goto :error
xcopy /E /I /Y tools "%OUTPUT_DIR%\tools\"
if exist LICENSE copy /Y LICENSE "%OUTPUT_DIR%\" >nul
if exist README.md copy /Y README.md "%OUTPUT_DIR%\" >nul
cd _releases && tar -czf FMSquared.%VERSION%-linux-x64.tar.gz FMSquared.%VERSION%-linux-x64 && cd ..
...
dotnet publish FMSquared.AvaloniaUI\FMSquared.AvaloniaUI.csproj -c Release --self-contained true -r osx-x64 -p:PublishSingleFile=false -o "%TEMP_OUTPUT_DIR%"
if %ERRORLEVEL% neq 0 goto :error
...
set OUTPUT_DIR=_releases
dotnet publish FMSquared.AvaloniaUI\FMSquared.AvaloniaUI.csproj -c Release --self-contained true -r osx-arm64 -p:PublishSingleFile=false -o "%TEMP_OUTPUT_DIR%"
if %ERRORLEVEL% neq 0 goto :error
xcopy /E /I /Y tools "%TEMP_OUTPUT_DIR%\tools\"
if exist LICENSE copy /Y LICENSE "%TEMP_OUTPUT_DIR%\" >nul
if exist README.md copy /Y README.md "%TEMP_OUTPUT_DIR%\" >nul
