...
public static class ChdConverter
{
        ...
        string? gameName = null)
    {
        try
        {
            ...
            // chdman stores CD-ROM audio big-endian, while BIN files need little-endian.
            bool swapAudio = true;
    ...
    // Batched so a full CD-ROM track never has to be held in memory at once.
    ...
    // Samples are 16-bit, so the swap is a straight byte pair exchange.
    ...
    // MSF is MM:SS:FF at 75 frames per second, 60 seconds per minute.
